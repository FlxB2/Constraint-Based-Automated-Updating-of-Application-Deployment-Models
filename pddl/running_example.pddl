(define (problem running_example)
	...
	(:init
		(inherits_from ubuntu-804 ubuntu)
		(inherits_from ubuntu-1804 ubuntu)
		(inherits_from tomcat-7 tomcat)
		(inherits_from java-6 java)
		(inherits_from java-8 java)
		...
		(is_used comp0)
		(is_of_type comp0 ubuntu-804)
		(is_used comp1)
		(is_of_type comp1 java-6)
		(connected_with comp1 comp0)
		(is_used comp2)
		(is_of_type comp2 tomcat-7)
		(connected_with comp2 comp0)
		(connected_with comp2 comp1)
		(is_used comp3)
		(is_of_type comp3 java-webshop-1)
		(connected_with comp3 comp2)
		(is_used comp4)
		(is_of_type comp4 mysqldb-51)
		(connected_with comp4 comp5)
		(connected_with comp3 comp4)
		(is_used comp5)
		(is_of_type comp5 mysqldbms-51)
		(connected_with comp5 comp6)
		(is_used comp6)
		(is_of_type comp6 ubuntu-804)
	)
	...
	(:goal
		(and (check_all_nodes)
			...
			(is_of_type comp3 java-webshop-1)
			(is_used comp0)
			(is_of_type comp0 ubuntu-1804)
			(is_used comp6)
			(is_of_type comp6 ubuntu-1804)))
)